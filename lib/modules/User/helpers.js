...
exports.loginUser = (app, user, loginVia, platformData) => __awaiter(this, void 0, void 0, function* () {
    ...
    const socialMediaData = utils_1.merge(user.get('socialMediaData'), platformData);
