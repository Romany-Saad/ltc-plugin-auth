...
const logging_1 = require("@cyber-crafts/ltc-core/lib/utils/logging");
...
exports.default = (container) => {
        ...
        resolve: ({ obj, args, context, info }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (!user) {
                ...
                if (authConfigs.maxAllowedFailedAttempts >= updateData.failedLoginAttempts) {
                    updateData.lockedUntil = utils_1.addToDate(new Date(), authConfigs.lockOutPeriod, utils_1.DateAdditionTypes.seconds);
                }
                user.set(updateData);
    ...
    schema_1.UserTC.addResolver({
        ...
        resolve: ({ obj, args, context, info }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            data.permissions = [];
            data.status = 'active';
            data.passwordExpiresAt = utils_1.addToDate(new Date(), authConfigs.passwordExpirationPeriod, utils_1.DateAdditionTypes.days);
    ...
    schema_1.UserTC.addResolver({
        ...
        resolve: ({ obj, args, context, info }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            data.permissions = [];
            data.status = 'active';
            data.passwordExpiresAt = utils_1.addToDate(new Date(), authConfig.passwordExpirationPeriod, utils_1.DateAdditionTypes.days);
            let newUser = repository.parse(data);
            let validation = yield newUser.selfValidate();
            if (validation.success) {
