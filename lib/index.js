    ...
    * */
    load(container) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            container.emitter.on(ltc_core_1.names.EV_PLUGINS_LOADING, (items) => __awaiter(this, void 0, void 0, function* () {
            ...
            utils_2.initializeSocialMediaLoginPlatforms(container);
            ...
            container.express.get('/oauth/callback', (req, res, next) => {
                ...
                return utils_2.socialMediaLogin(container, req.query.platform, req.user)
                    .then(data => {
                    if (data.success) {
