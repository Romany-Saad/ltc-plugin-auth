...
exports.names = {
    ...
    AUTH_ROLES_REPOSITORY: Symbol(utils_1.namer.resolve('auth', 'roles', 'repository')),
    ...
    * */
    load(container) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const roles = new Role_1.Roles(connection.getClient(), `roles`);
            container.bind(exports.names.AUTH_ROLES_REPOSITORY).toConstantValue(roles);
            c2v_1.Context.bind(exports.names.AUTH_ROLES_REPOSITORY, roles);
